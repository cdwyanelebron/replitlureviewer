...
export const MIDTERM_FOCUS_SUBJECTS: Subject[] = [
  ...
  },
  {
    ...
    shortTitle: "GE 8",
    units: 3,
    description: "Focused midterm reviewer from the attached GE8 Ethics modules: Feelings and Moral Decision Making, Moral Reasoning and Moral Courage, Virtue Ethics (Aristotle and Natural Law), and Deontology (Kant and Kinds of Rights). Includes detailed lessons, quizzes per subtopic, and a comprehensive exam.",
    terms: [
      {
        id: "midterm",
        label: "MIDTERM",
  ...
  },
  {
    ...
    shortTitle: "NSTP 2",
    units: 3,
    description: "Focused midterm reviewer from the attached NSTP2 CWTS modules: Disaster Preparedness and Response, Response to the COVID-19 Pandemic, and Self-Care for Wellness. Includes detailed lessons, quizzes per subtopic, and a comprehensive exam.",
    terms: [
      {
        id: "midterm",
        label: "MIDTERM",
