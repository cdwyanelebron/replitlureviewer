...
export const CC_SUBJECTS: Subject[] = [
...

  {
    ...
    shortTitle: "IT 1201",
    units: 3,
    description: "Introduces IT infrastructure components including hardware, software, networks, and cloud computing. Covers the fundamentals of networking, protocols, and basic network administration.",
    terms: [
      {
        id: "prelim", label: "PRELIM",
        modules: [
          {
            id: "it1201-m1", title: "Module 1: IT Infrastructure Components",
            topics: [
              {
                id: "it1201-m1t1", title: "Overview of IT Infrastructure",
                content: {
                  heading: "Overview of IT Infrastructure", term: "PRELIM", module: "Module 1: IT Infrastructure Components",
                  objectives: ["Define IT infrastructure and its components", "Identify hardware, software, and network components", "Describe the role of IT infrastructure in organizations"],
                  sections: [
                    { type: "h2", content: "What is IT Infrastructure?" },
                    { type: "definition", content: "IT Infrastructure — The composite hardware, software, network resources, and services required for the existence, operation, and management of an enterprise IT environment. It enables delivery of IT services to employees, partners, and customers." },
                    { type: "h3", content: "Components of IT Infrastructure" },
                    { type: "table", content: "IT Infrastructure Components", headers: ["Component", "Description", "Examples"], rows: [["Hardware", "Physical devices and equipment", "Servers, workstations, routers, switches, storage"], ["Software", "Programs and operating systems", "OS, applications, database software, middleware"], ["Network", "Communication infrastructure", "LAN, WAN, internet, Wi-Fi, VPN"], ["Data Center", "Centralized facility housing servers and network equipment", "On-premise data center, cloud data center"], ["Human Resources", "IT staff managing the infrastructure", "System admins, network engineers, IT support"], ["Cloud Services", "Remote computing resources over the internet", "AWS, Azure, Google Cloud"]] },
                    { type: "h3", content: "Types of Servers" },
                    { type: "list", content: "Server Types", items: ["Web Server — Hosts websites and web applications (Apache, Nginx, IIS)", "File Server — Stores and manages shared files", "Database Server — Hosts database management systems (MySQL, PostgreSQL)", "Mail Server — Manages email (Postfix, Microsoft Exchange)", "Application Server — Runs business applications", "DNS Server — Resolves domain names to IP addresses", "DHCP Server — Automatically assigns IP addresses to devices"] },
                    { type: "note", content: "A 'server' is simply a computer that provides services to other computers (clients) on a network. Any computer can technically function as a server if configured to provide services." },
                  ],
                  quiz: [
                    { question: "Which component of IT infrastructure includes physical devices like servers and routers?", options: ["Software", "Network", "Hardware", "Cloud Services"], answer: 2, explanation: "Hardware includes physical devices such as servers, workstations, routers, switches, and storage systems." },
                    { question: "A DNS server is responsible for:", options: ["Automatically assigning IP addresses", "Hosting websites", "Resolving domain names to IP addresses", "Managing shared files"], answer: 2, explanation: "DNS (Domain Name System) servers resolve domain names (like www.google.com) into IP addresses (142.250.185.46)." },
                  ],
                },
              },
            ],
      ...
      },
      {
        ...
        modules: [
          {
            id: "it1201-m2", title: "Module 2: Network Fundamentals",
            topics: [
              {
                id: "it1201-m2t1", title: "IP Addressing and Subnetting",
                content: {
                  heading: "IP Addressing and Subnetting", term: "MIDTERM", module: "Module 2: Network Fundamentals",
                  objectives: ["Explain IPv4 and IPv6 addressing", "Describe subnetting and subnet masks", "Identify classes of IP addresses"],
                  sections: [
                    { type: "h2", content: "IP Addressing" },
                    { type: "definition", content: "IP Address (Internet Protocol Address) — A unique numerical label assigned to each device connected to a network. It identifies the device's location and enables communication." },
                    { type: "h3", content: "IPv4 vs IPv6" },
                    { type: "table", content: "IPv4 vs. IPv6 Comparison", headers: ["Feature", "IPv4", "IPv6"], rows: [["Address Format", "32-bit, dotted decimal (192.168.1.1)", "128-bit, hexadecimal (2001:0db8::1)"], ["Total Addresses", "~4.3 billion", "~340 undecillion (3.4 × 10³⁸)"], ["Status", "Exhausted/running out", "The future of internet addressing"], ["Header Size", "20-60 bytes", "Fixed 40 bytes"]] },
                    { type: "h3", content: "IPv4 Address Classes" },
                    { type: "table", content: "IPv4 Address Classes", headers: ["Class", "Range", "Default Subnet Mask", "Use"], rows: [["A", "0.0.0.0 – 127.255.255.255", "255.0.0.0 (/8)", "Large networks; ISPs, governments"], ["B", "128.0.0.0 – 191.255.255.255", "255.255.0.0 (/16)", "Medium networks; universities"], ["C", "192.0.0.0 – 223.255.255.255", "255.255.255.0 (/24)", "Small networks; home/small business"], ["D", "224.0.0.0 – 239.255.255.255", "N/A", "Multicast"], ["E", "240.0.0.0 – 255.255.255.255", "N/A", "Reserved/Experimental"]] },
                    { type: "h3", content: "Private IP Ranges" },
                    { type: "list", content: "Private IP Address Ranges (RFC 1918)", items: ["Class A: 10.0.0.0 – 10.255.255.255 (/8)", "Class B: 172.16.0.0 – 172.31.255.255 (/12)", "Class C: 192.168.0.0 – 192.168.255.255 (/16)"] },
                    { type: "note", content: "Private IP addresses are used within local networks (home, office). They are not routable on the internet. NAT (Network Address Translation) converts private IPs to public IPs for internet access." },
                  ],
                  quiz: [
                    { question: "Which IP address is in the Class C private range?", options: ["10.0.0.1", "172.16.5.1", "192.168.1.100", "8.8.8.8"], answer: 2, explanation: "192.168.1.100 is in the Class C private range (192.168.0.0 – 192.168.255.255)." },
                    { question: "IPv6 uses how many bits for addressing?", options: ["32 bits", "64 bits", "128 bits", "256 bits"], answer: 2, explanation: "IPv6 uses 128-bit addresses, providing approximately 340 undecillion unique addresses." },
                    { question: "The default subnet mask for a Class C network is:", options: ["255.0.0.0", "255.255.0.0", "255.255.255.0", "255.255.255.255"], answer: 2, explanation: "Class C networks use 255.255.255.0 (/24) as the default subnet mask." },
                  ],
                },
              },
              {
                id: "it1201-m2t2", title: "Network Devices and Protocols",
                content: {
                  heading: "Network Devices and Protocols", term: "MIDTERM", module: "Module 2: Network Fundamentals",
                  objectives: ["Identify common network devices and their functions", "Distinguish between hub, switch, and router", "Describe common network protocols"],
                  sections: [
                    { type: "h2", content: "Network Devices" },
                    { type: "table", content: "Network Devices and Functions", headers: ["Device", "OSI Layer", "Function"], rows: [["Hub", "Layer 1 (Physical)", "Broadcasts data to all connected devices; dumb device"], ["Switch", "Layer 2 (Data Link)", "Forwards data to specific device using MAC address; smarter than hub"], ["Router", "Layer 3 (Network)", "Routes data between networks using IP addresses; connects LAN to internet"], ["Modem", "Layer 1", "Converts digital to analog signals; connects to ISP"], ["Firewall", "Layer 3-4", "Monitors and filters network traffic for security"], ["Access Point", "Layer 2", "Provides wireless (Wi-Fi) connectivity"]] },
                    { type: "h3", content: "Common Network Protocols" },
                    { type: "table", content: "Common Network Protocols", headers: ["Protocol", "Full Name", "Purpose", "Port"], rows: [["HTTP", "HyperText Transfer Protocol", "Web browsing", "80"], ["HTTPS", "HTTP Secure", "Encrypted web browsing", "443"], ["FTP", "File Transfer Protocol", "File transfer", "21"], ["SMTP", "Simple Mail Transfer Protocol", "Sending email", "25"], ["POP3", "Post Office Protocol 3", "Receiving email", "110"], ["IMAP", "Internet Message Access Protocol", "Email access (server-side)", "143"], ["DNS", "Domain Name System", "Domain name resolution", "53"], ["DHCP", "Dynamic Host Configuration Protocol", "Automatic IP assignment", "67/68"], ["SSH", "Secure Shell", "Secure remote administration", "22"]] },
                  ],
                  quiz: [
                    { question: "Which network device forwards data to a specific device using its MAC address?", options: ["Hub", "Switch", "Router", "Modem"], answer: 1, explanation: "A switch forwards data frames to a specific device based on its MAC address, unlike a hub which broadcasts to all." },
                    { question: "HTTPS uses port:", options: ["80", "443", "21", "22"], answer: 1, explanation: "HTTPS (HTTP Secure) uses port 443. Regular HTTP uses port 80." },
                    { question: "DHCP is used to:", options: ["Resolve domain names", "Transfer files securely", "Automatically assign IP addresses to devices", "Send email messages"], answer: 2, explanation: "DHCP (Dynamic Host Configuration Protocol) automatically assigns IP addresses and other network settings to devices when they connect to a network." },
                  ],
                },
              },
            ],
      ...
      },
      {
        ...
        modules: [
          {
            id: "it1201-m3", title: "Module 3: Cloud Computing",
            topics: [
              {
                id: "it1201-m3t1", title: "Cloud Computing Fundamentals",
                content: {
                  heading: "Cloud Computing Fundamentals", term: "FINALS", module: "Module 3: Cloud Computing",
                  objectives: ["Define cloud computing and its characteristics", "Identify cloud service models (IaaS, PaaS, SaaS)", "Distinguish deployment models (public, private, hybrid)"],
                  sections: [
                    { type: "h2", content: "Cloud Computing" },
                    { type: "definition", content: "Cloud Computing — The delivery of computing services (servers, storage, databases, networking, software, analytics, intelligence) over the internet ('the cloud') to offer faster innovation, flexible resources, and economies of scale." },
                    { type: "h3", content: "Five Essential Characteristics (NIST)" },
                    { type: "list", content: "NIST Cloud Characteristics", items: ["On-demand self-service — Provision computing without human interaction", "Broad network access — Available over the network via standard mechanisms", "Resource pooling — Multiple customers share physical resources", "Rapid elasticity — Scale up or down quickly based on demand", "Measured service — Usage is monitored, controlled, and reported (pay-as-you-go)"] },
                    { type: "h3", content: "Cloud Service Models" },
                    { type: "table", content: "Cloud Service Models", headers: ["Model", "Full Name", "Description", "Examples"], rows: [["IaaS", "Infrastructure as a Service", "Provides virtualized computing resources (servers, storage, networking)", "AWS EC2, Azure VMs, Google Compute Engine"], ["PaaS", "Platform as a Service", "Provides platform and environment for developing, testing, and deploying apps", "Heroku, Google App Engine, Azure App Service"], ["SaaS", "Software as a Service", "Delivers ready-to-use software over the internet; no installation needed", "Gmail, Microsoft 365, Salesforce, Zoom"]] },
                    { type: "h3", content: "Cloud Deployment Models" },
                    { type: "table", content: "Cloud Deployment Models", headers: ["Model", "Description", "Best For"], rows: [["Public Cloud", "Resources owned and managed by cloud provider; shared with others", "Small businesses, startups, web apps"], ["Private Cloud", "Resources dedicated exclusively to one organization", "Government, healthcare, financial institutions"], ["Hybrid Cloud", "Combination of public and private cloud", "Enterprises needing flexibility and security"]] },
                  ],
                  quiz: [
                    { question: "Gmail is an example of which cloud service model?", options: ["IaaS", "PaaS", "SaaS", "DaaS"], answer: 2, explanation: "Gmail is SaaS (Software as a Service) — it's a ready-to-use software delivered over the internet without installation." },
                    { question: "Which cloud deployment model is dedicated exclusively to one organization?", options: ["Public cloud", "Private cloud", "Hybrid cloud", "Community cloud"], answer: 1, explanation: "A private cloud is dedicated to a single organization, offering greater control and security." },
                    { question: "The 'pay-as-you-go' characteristic of cloud computing is called:", options: ["On-demand self-service", "Resource pooling", "Measured service", "Rapid elasticity"], answer: 2, explanation: "Measured service (pay-as-you-go) means usage is monitored and billed based on actual consumption." },
                  ],
                },
              },
            ],
